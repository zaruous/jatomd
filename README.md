...
```bash
java -jar target/spring-hierarchy-analyzer.jar myapp.jar
```
...
✅ 리포트 저장 완료: myapp-call-hierarchy.md
```
...
| 파일 | 내용 |
|---|---|
| `{jar명}-call-hierarchy.md` | 엔드포인트별 호출 트리, 파라미터 테이블, BeanUtils 요약, LLM 컨텍스트 블록 |
